...
merchant1 = Merchant.create!(name: 'Kaiju', address: '1531 Madison Ave', city: 'New York', state: 'NY', zip: '10005')
merchant2 = Merchant.create!(name: 'Donk', address: '321 Rodeo', city: 'Beverly Hills', state: 'CA', zip: '90210')
merchant3 = Merchant.create!(name: 'Julius', address: '1156 Berry Loop', city: 'Austin', state: 'TX', zip:'73301')
merchant4 = Merchant.create!(name: 'Campbell', address: '312 Sailers Way', city: 'Seattle', state: 'WA', zip: '98101')
merchant5 = Merchant.create!(name: 'Batman', address: '546 West Grady Street', city: 'Boston', state: 'MA', zip: '02101')
merchant6 = Merchant.create!(name: 'Fini', address: '1974 Peachtree Way', city: 'Atlanta', state: 'GA', zip: '30305')
...
alex_address = alex.addresses.create!(address: "123 Straw Lane", city: "Straw City", state: "CO", zip: 12345)
berry = User.create!(name: "Berry Blue", email: "blue@gmail.com", password: "bear", role: 1, merchant_id: megan.id)
berry_address = berry.addresses.create!(address: "345 Blue Lane", city: "Blue City", state: "CA", zip: 56789)
larry = User.create!(name: "Larry Green", email: "green@gmail.com", password: "frogs", role: 1, merchant_id: brian.id)
larry_address = larry.addresses.create!(address: "345 Blue Lane", city: "Blue City", state: "CA", zip: 56789)
jeff = User.create!(name: "Jeff Casimir", email: "jeff@gmail.com", password: "jeff", role: 2)
jeff_address = jeff.addresses.create!(address: "345 Blue Lane", city: "Blue City", state: "CA", zip: 56789)
order_1 = alex.orders.create!(address: alex_address)
order_2 = berry.orders.create!(address: berry_address)
order_1.order_items.create!(item: lobster, price: lobster.price, quantity: 2, fulfilled: true)
order_1.order_items.create!(item: emmet, price: emmet.price, quantity: 3, fulfilled: false)
order_2.order_items.create!(item: rex, price: rex.price, quantity: 2, fulfilled: true)
order_2.order_items.create!(item: hippo, price: hippo.price, quantity: 2, fulfilled: true)
order_3 = alex.orders.create!(address: alex_address)
order_4 = berry.orders.create!(address: berry_address)
order_4.order_items.create!(item: hamley, price: hamley.price, quantity: 2, fulfilled: true)
order_4.order_items.create!(item: hippo, price: hippo.price, quantity: 3, fulfilled: false)
order_3.order_items.create!(item: hippo, price: hippo.price, quantity: 3, fulfilled: true)
order_3.order_items.create!(item: eraser, price: eraser.price, quantity: 2, fulfilled: true)
order_5 = alex.orders.create!(address: alex_address)
order_6 = berry.orders.create!(address: berry_address)
order_5.order_items.create!(item: ogre, price: ogre.price, quantity: 2, fulfilled: true)
order_5.order_items.create!(item: eraser, price: eraser.price, quantity: 3, fulfilled: false)
order_6.order_items.create!(item: hippo, price: hippo.price, quantity: 2, fulfilled: true)
order_7 = alex.orders.create!(address: alex_address)
order_8 = berry.orders.create!(address: berry_address)
order_7.order_items.create!(item: ogre, price: ogre.price, quantity: 2, fulfilled: true)
order_7.order_items.create!(item: hippo, price: hippo.price, quantity: 3, fulfilled: false)
order_8.order_items.create!(item: hippo, price: hippo.price, quantity: 2, fulfilled: true)
order_8.order_items.create!(item: hippo, price: hippo.price, quantity: 2, fulfilled: true)
order_9 = alex.orders.create!(address: alex_address)
order_10 = berry.orders.create!(address: berry_address)
order_10.order_items.create!(item: ogre, price: ogre.price, quantity: 2, fulfilled: true)
order_10.order_items.create!(item: sherry, price: sherry.price, quantity: 3, fulfilled: false)
order_9.order_items.create!(item: wonder, price: wonder.price, quantity: 2, fulfilled: true)
order_9.order_items.create!(item: hippo, price: hippo.price, quantity: 2, fulfilled: true)
order_11 = alex.orders.create!(address: alex_address)
order_12 = berry.orders.create!(address: berry_address)
order_11.order_items.create!(item: sherry, price: sherry.price, quantity: 2, fulfilled: true)
order_11.order_items.create!(item: joker, price: joker.price, quantity: 3, fulfilled: false)
order_12.order_items.create!(item: kitty, price: kitty.price, quantity: 2, fulfilled: true)
order_12.order_items.create!(item:quinn, price:quinn.price, quantity: 2, fulfilled: true)
order_13 = alex.orders.create!(address: alex_address)
order_14 = berry.orders.create!(address: berry_address)
order_13.order_items.create!(item: hula, price: hula.price, quantity: 2, fulfilled: true)
order_14.order_items.create!(item: quinn, price: quinn.price, quantity: 3, fulfilled: false)
order_14.order_items.create!(item: dick, price: dick.price, quantity: 2, fulfilled: true)
order_13.order_items.create!(item: america, price: america.price, quantity: 2, fulfilled: true)
order_15 = alex.orders.create!(address: alex_address)
order_16 = berry.orders.create!(address: berry_address)
order_16.order_items.create!(item: melon, price: melon.price, quantity: 2, fulfilled: true)
order_15.order_items.create!(item: lucy, price: lucy.price, quantity: 3, fulfilled: false)
order_16.order_items.create!(item: lucy, price: lucy.price, quantity: 2, fulfilled: true)
order_15.order_items.create!(item: candy, price: candy.price, quantity: 2, fulfilled: true)
order_17 = alex.orders.create!(address: alex_address)
order_18 = berry.orders.create!(address: berry_address)
order_17.order_items.create!(item: programmer, price: programmer.price, quantity: 2, fulfilled: true)
order_17.order_items.create!(item: lion, price: lion.price, quantity: 3, fulfilled: false)
order_18.order_items.create!(item: america, price: america.price, quantity: 2, fulfilled: true)
order_18.order_items.create!(item: hippo, price: hippo.price, quantity: 2, fulfilled: true)
order_19 = alex.orders.create!(address: alex_address)
order_20 = berry.orders.create!(address: berry_address)
order_19.order_items.create!(item: superman, price: superman.price, quantity: 2, fulfilled: true)
order_19.order_items.create!(item: lobster, price: lobster.price, quantity: 3, fulfilled: false)
order_20.order_items.create!(item: abe, price: abe.price, quantity: 2, fulfilled: true)
order_20.order_items.create!(item: hippo, price: hippo.price, quantity: 2, fulfilled: true)
order_21 = alex.orders.create!(address: alex_address)
order_22 = berry.orders.create!(address: berry_address)
order_21.order_items.create!(item: kitty, price: kitty.price, quantity: 2, fulfilled: true)
order_21.order_items.create!(item: groot, price: groot.price, quantity: 3, fulfilled: false)
order_22.order_items.create!(item: groot, price: groot.price, quantity: 2, fulfilled: true)
order_22.order_items.create!(item: wonder, price: wonder.price, quantity: 2, fulfilled: true)
order_23 = alex.orders.create!(address: alex_address)
order_24 = berry.orders.create!(address: berry_address)
order_23.order_items.create!(item: kitty, price: kitty.price, quantity: 2, fulfilled: true)
order_24.order_items.create!(item: anakin, price: anakin.price, quantity: 3, fulfilled: false)
order_23.order_items.create!(item: superman, price: superman.price, quantity: 2, fulfilled: true)
order_24.order_items.create!(item: hippo, price: hippo.price, quantity: 2, fulfilled: true)
order_25 = alex.orders.create!(address: alex_address)
order_26 = berry.orders.create!(address: berry_address)
order_26.order_items.create!(item: groot, price: groot.price, quantity: 2, fulfilled: true)
order_26.order_items.create!(item: superman, price: superman.price, quantity: 3, fulfilled: false)
order_25.order_items.create!(item: superman, price: superman.price, quantity: 2, fulfilled: true)
order_25.order_items.create!(item: pop, price: pop.price, quantity: 2, fulfilled: true)
order_27 = alex.orders.create!(address: alex_address)
order_28 = berry.orders.create!(address: berry_address)
order_27.order_items.create!(item: gordon, price: gordon.price, quantity: 2, fulfilled: true)
order_27.order_items.create!(item: melon, price: melon.price, quantity: 3, fulfilled: false)
order_28.order_items.create!(item: pop, price: pop.price, quantity: 2, fulfilled: true)
order_28.order_items.create!(item: candy, price: candy.price, quantity: 2, fulfilled: true)

...
RSpec.describe 'Merchant Order Show Page' do
  describe 'As a Merchant' do
    ...
    it 'I can see order information with only my order items' do
      ...
      expect(page).to have_content(@m_user.user_addresses.first.address)
      expect(page).to have_content(@m_user.user_addresses.first.city)
      expect(page).to have_content(@m_user.user_addresses.first.state)
      expect(page).to have_content(@m_user.user_addresses.first.zip)

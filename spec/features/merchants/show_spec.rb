...
RSpec.describe 'Merchant Show Page' do
  describe 'As a visitor' do
    before :each do
      ...
      @user_1.addresses.create(address: '123 Main St', city: 'Denver', state: 'CO', zip: 80218, alias: 'Home')
      @user_2 = User.create!(name: 'Megan', email: 'megan_2@example.com', password: 'securepassword')
      @user_2.addresses.create(address: '123 Main St', city: 'Denver', state: 'IA', zip: 80218, alias: 'Home')
